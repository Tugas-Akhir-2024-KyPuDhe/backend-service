...
router.get("/get", authMiddleware, authorizeRoles(['STAFF', 'TEACHER', 'STUDENT']), classStudentController.getAllClass);
router.get("/get/:id", authMiddleware, authorizeRoles(['STAFF', 'TEACHER']), classStudentController.getClassById);
